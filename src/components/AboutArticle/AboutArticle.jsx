    ...
    <>
      <article className="about_article">
        ...
        <section className="about_img">
          <img src="../assets/starturweb_logo.png" alt="starturweb_logo" />
          <img src="../assets/imagine_person.png" alt="imagine_person_logo" />
          <img src="../assets/cart.png" alt="cart_logo" />
          <img src="../assets/cloud.png" alt="cloud_logo" />
        </section>
      </article>
    </>
  );
